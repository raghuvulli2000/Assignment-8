...
export class BackendApiService {
  ...
  fetchIdDetail(id: string){
    ...
    console.log(id);
    var trl = "https://business-app-angular-node.wl.r.appspot.com" + "/businessid?id=" + id;
    console.log(trl);
    ...
    var prl = "https://business-app-angular-node.wl.r.appspot.com" + "/businessid?id=" + id + "/reviews";
    console.log(prl);
